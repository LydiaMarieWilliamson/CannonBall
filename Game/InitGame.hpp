...
//	Bit 3: Loop back to stage 1
   Num1 end_stage_props;
   Num4 car_increment; // NEEDS REPLACING. Implementing here as a quick hack so routine works
// Car X Position
...
//	-1 = In Progress
   ...
   void init_bonus(Int2); // moved here for debugging purposes
private:
// Road width at merge point
   const static Num2 RD_WIDTH_MERGE = 0xD4;
// Road width of next section
   Int2 road_width_next;
